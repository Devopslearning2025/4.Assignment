...
#test_file=$1
test_file=[ "EC2" "Dashboard" "EC2" "Global" "View" "Events" "Console-to-Code"
"Preview Instances "Instances" "Instances" "Types" "Launch" "Templates" "Spot" "Requests"
"Savings" "Plans Reserved" "Instances" "Dedicated" "Hosts"
"Capacity" "Reservations" "New" "Images"
"Instances"
"Reservations"
"Savings"
"Preview" "Instances" "Global" "Events" "Instances" "Dashboard" ]
